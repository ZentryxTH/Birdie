...
import 'authorize_model.dart';
export 'authorize_model.dart';

class AuthorizeWidget extends StatefulWidget {
  const AuthorizeWidget({super.key});

  @override
  State<AuthorizeWidget> createState() => _AuthorizeWidgetState();
}

class _AuthorizeWidgetState extends State<AuthorizeWidget>
    with TickerProviderStateMixin {
  late AuthorizeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthorizeModel());
